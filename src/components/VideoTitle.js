const VideoTitle = ({ title, overview }) => {
  return (
    <div className="absolute inset-0 flex flex-col justify-center px-24 pt-30 text-white bg-gradient-to-r from-black via-black/70 to-transparent z-20">
      
      <h1 className="text-4xl font-bold max-w-2xl leading-tight">
        {title}
      </h1>

      <p className="mt-4 text-md max-w-xl text-gray-200">
        {overview}
      </p>
